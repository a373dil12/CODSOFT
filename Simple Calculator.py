...
b.pack(side=LEFT,padx=18,pady=10)
b.bind('<Button-1>',click)
b=Button(f,text='0',padx=27,pady=12,font='lucida 35 bold',bg='blue')
b.pack(side=LEFT,padx=18,pady=10)
b.bind('<Button-1>',click)
b=Button(f,text='=',padx=27,pady=12,font='lucida 35 bold',bg='yellow')
b.pack(side=LEFT,padx=18,pady=10)
b.bind('<Button-1>',click)
b=Button(f,text='/',padx=27,pady=12,font='lucida 35 bold',bg='green')
