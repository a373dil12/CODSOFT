...
def password_generate():
    try:
        ...
        messagebox.askretrycancel('A Problem Has Been ccured','Please Try Again')

# this is for selecting the length of our password........O
...
length=Label(root,text='Select The Length of Your Password : ',fg='white',bg='black',font=('ubuntu',12,'bold'))
...
result_lable=Label(root,text='Generated Password Here : ',bg='pink',fg='black',font=('ubuntu',12,'bold'))
